...
class DepartVoyageUseCase:
    """Depart planned voyage through domain lifecycle API."""
        ...
        try:
            with self._unit_of_work as uow:
                ...
                voyage.depart(
                    ...
                    actual_departure_location=to_location_snapshot(
                        request.actual_departure_location
                    ),
                )
            ...
            raise RepositoryException("Depart voyage failed") from exc

        return DepartVoyageResponse(voyage=to_voyage_response(voyage))
