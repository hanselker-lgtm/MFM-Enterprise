...
class CloseFiscalYearUseCase:
    """Transition fiscal year lifecycle state to CLOSED."""
    ...
    def execute(self, request: CloseFiscalYearRequest) -> CloseFiscalYearResponse:
        ...
        try:
            ...
            raise RepositoryException("Close fiscal year failed") from exc

        return CloseFiscalYearResponse(fiscal_year=to_fiscal_year_response(fiscal_year))
