...
class ReceiveStockUseCase:
    """Receive stock through aggregate-owned receipt operation."""
    ...
    def execute(self, request: ReceiveStockRequest) -> ReceiveStockResponse:
        ...
        try:
            ...
            raise RepositoryException("Receive stock failed") from exc

        return ReceiveStockResponse(inventory_item=to_inventory_item_response(item))
