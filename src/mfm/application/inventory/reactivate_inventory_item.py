"""Reactivate Inventory Item use case."""
...
class ReactivateInventoryItemUseCase:
    """Reactivate inventory item when lifecycle preconditions are met."""

    def __init__(self, *, unit_of_work: AbstractUnitOfWork) -> None:
        self._unit_of_work = unit_of_work

    def execute(self, request: ReactivateInventoryItemRequest) -> ReactivateInventoryItemResponse:
        request.validate()
        ...
        try:
            ...
            raise RepositoryException("Reactivate inventory item failed") from exc
