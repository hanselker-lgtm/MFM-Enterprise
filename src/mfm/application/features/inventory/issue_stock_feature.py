"""Issue stock feature facade following Public API Standard."""
...
from mfm.application.inventory.issue_stock import IssueStockRequest as ServiceRequest
from mfm.application.inventory.issue_stock import IssueStockResponse as ServiceResponse
...
class IssueStockService(Protocol):
    def execute(self, request: ServiceRequest) -> ServiceResponse: ...


class IssueStockFeature:
    """Feature facade for inventory stock issue."""

    def __init__(self, *, service: IssueStockService) -> None:
    ...
    def execute(self, request: IssueStockRequest) -> IssueStockResponse:
        ...
        try:
            ...
            raise RepositoryException("Issue stock feature failed") from exc
