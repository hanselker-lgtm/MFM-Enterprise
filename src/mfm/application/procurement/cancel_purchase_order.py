...
class CancelPurchaseOrderUseCase:
    """Cancel purchase order through domain lifecycle API."""
    ...
    def execute(self, request: CancelPurchaseOrderRequest) -> CancelPurchaseOrderResponse:
        ...
        try:
            ...
            raise RepositoryException("Cancel purchase order failed") from exc

        return CancelPurchaseOrderResponse(purchase_order=to_purchase_order_response(order))
