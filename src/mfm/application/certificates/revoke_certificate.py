...
class RevokeCertificateUseCase:
    """Revoke certificate through domain lifecycle operation."""
    ...
    def execute(self, request: RevokeCertificateRequest) -> RevokeCertificateResponse:
        ...
        try:
            with self._unit_of_work as uow:
                ...
                certificate.revoke(notes=request.notes)
            ...
            raise RepositoryException("Revoke certificate failed") from exc

        return RevokeCertificateResponse(certificate=to_certificate_response(certificate))
