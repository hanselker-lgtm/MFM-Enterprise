...
def test_application_shell_can_use_events_activities_workspace_loader(qapp) -> None:
    shell = build_application_shell(
        ...
        events_activities_workspace_loader=lambda: QLabel("Events Activities Workspace"),
    )
