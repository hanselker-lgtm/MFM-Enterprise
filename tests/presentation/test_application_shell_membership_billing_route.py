...
def test_application_shell_can_use_membership_billing_workspace_loader(qapp) -> None:
    shell = build_application_shell(
        ...
        membership_billing_workspace_loader=lambda: QLabel("Membership Billing Workspace"),
    )
