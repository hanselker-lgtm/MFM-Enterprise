...
def test_application_shell_can_use_contact_communication_workspace_loader(qapp) -> None:
    shell = build_application_shell(
        ...
        contact_communication_workspace_loader=lambda: QLabel("Contact Communication Workspace"),
    )
