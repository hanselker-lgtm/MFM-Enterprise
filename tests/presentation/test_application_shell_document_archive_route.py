...
def test_application_shell_can_use_document_archive_workspace_loader(qapp) -> None:
    shell = build_application_shell(
        ...
        document_archive_workspace_loader=lambda: QLabel("Document Archive Workspace"),
    )
