...
def test_application_shell_can_use_organization_roles_workspace_loader(qapp) -> None:
    shell = build_application_shell(
        ...
        organization_roles_workspace_loader=lambda: QLabel("Organization Roles Workspace"),
    )
